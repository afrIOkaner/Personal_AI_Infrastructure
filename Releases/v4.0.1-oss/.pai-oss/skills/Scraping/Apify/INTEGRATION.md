...
**Location:** `~/.pai-oss/skills/social/SKILL.md`
...
2. System runs: `bun ~/.pai-oss/filesystem-mcps/apify/get-latest-tweet.ts`
...
bun ~/.pai-oss/filesystem-mcps/apify/get-user-tweets.ts ThePrimeagen 10

# Analyze Paul Graham's recent thoughts
bun ~/.pai-oss/filesystem-mcps/apify/get-user-tweets.ts paulg 20

# Track Simon Willison's posts
bun ~/.pai-oss/filesystem-mcps/apify/get-user-tweets.ts simonw 15
```
...
bun ~/.pai-oss/filesystem-mcps/apify/get-latest-thread.ts
...
bun ~/.pai-oss/filesystem-mcps/apify/get-latest-tweet.ts
...
✅ Run from `~/.pai-oss/filesystem-mcps/apify/` directory or use full path
...
**For Users:**
- Quick reference: `~/.pai-oss/filesystem-mcps/SCRIPTS-REFERENCE.md`
- Social skill: `~/.pai-oss/skills/social/SKILL.md`

**For Developers:**
- Implementation: `~/.pai-oss/filesystem-mcps/apify/README.md`
- Standards: `~/.pai-oss/filesystem-mcps/STANDARDS.md`
- Parent guide: `~/.pai-oss/filesystem-mcps/README.md`
