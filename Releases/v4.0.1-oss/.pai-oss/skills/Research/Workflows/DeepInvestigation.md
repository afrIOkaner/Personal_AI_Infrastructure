...
```
~/.pai-oss/MEMORY/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `~/.pai-oss/MEMORY/STATE/current-work.json` for the active work directory.
...
Templates live at `~/.pai-oss/skills/Research/Templates/{DomainName}.md`
