...
**Patterns Location:** `~/.pai-oss/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `~/.pai-oss/skills/Fabric/`.
...
```bash
ls ~/.pai-oss/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls ~/.pai-oss/skills/Fabric/Patterns/`
**Fabric Skill:** `~/.pai-oss/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `~/.pai-oss/skills/Fabric/Patterns/official_pattern_template/`
