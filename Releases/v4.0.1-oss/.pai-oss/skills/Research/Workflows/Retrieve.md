...
**Working Directory:** `~/.pai-oss/MEMORY/WORK/{current_work}/`
...
2. **History (Permanent Archive):**
   ...
   - Move to `~/.pai-oss/History/research/YYYY-MM-DD_[description]/` when complete
...
```
~/.pai-oss/MEMORY/WORK/20260111-172408_retrieve-react19-docs/
├── raw-content/
...
```
~/.pai-oss/History/research/2025-10-26_react19-documentation/
