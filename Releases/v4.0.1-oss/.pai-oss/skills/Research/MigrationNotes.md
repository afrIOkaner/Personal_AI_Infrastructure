...
- **Source:** `~/.pai-oss/commands/perform-claude-research.md`
- **Destination:** `~/.pai-oss/skills/Research/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
...
- **Source:** `~/.pai-oss/commands/perform-perplexity-research.md`
- **Destination:** `~/.pai-oss/skills/Research/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Source:** `~/.pai-oss/commands/perform-interview-research.md`
- **Destination:** `~/.pai-oss/skills/Research/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Source:** `~/.pai-oss/commands/analyze-ai-trends.md`
- **Destination:** `~/.pai-oss/skills/Research/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `~/.pai-oss/skills/Research/Workflows/`
...
The original command files remain in `~/.pai-oss/commands/`:
