...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `~/.pai-oss/PAI/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.pai-oss/PAI/USER/TELOS/` |
...
All files located in `~/.pai-oss/PAI/USER/TELOS/`:
...
```bash
# View specific file
read ~/.pai-oss/PAI/USER/TELOS/GOALS.md
read ~/.pai-oss/PAI/USER/TELOS/BELIEFS.md

# View recent updates
read ~/.pai-oss/PAI/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.pai-oss/PAI/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `~/.pai-oss/PAI/USER/TELOS/` (in the CORE USER directory)
