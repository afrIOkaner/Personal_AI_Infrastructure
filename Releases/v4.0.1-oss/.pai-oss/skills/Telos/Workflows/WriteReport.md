...
cp -r ~/.pai-oss/skills/Telos/ReportTemplate/* {output_dir}/
...
```
~/.pai-oss/skills/Telos/ReportTemplate/
```
...
Edit files in `~/.pai-oss/skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `~/.pai-oss/skills/Telos/ReportTemplate/app/globals.css`
