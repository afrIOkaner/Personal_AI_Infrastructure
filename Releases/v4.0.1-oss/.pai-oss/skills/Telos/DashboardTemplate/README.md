...
```bash
cp -r ~/.pai-oss/skills/telos/dashboard-template /path/to/your/project
...
- Searches `~/.pai-oss/skills/Telos/` for `.md` files
- Searches `~/.pai-oss/skills/Telos/data/` for `.csv` files
