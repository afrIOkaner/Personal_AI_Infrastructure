...
```bash
Read ~/.pai-oss/skills/Media/Art/SKILL.md
```
...
bun run ~/.pai-oss/skills/art/Tools/Generate.ts \
...
bun ~/.pai-oss/PAI/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun ~/.pai-oss/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `~/.pai-oss/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in ~/.pai-oss/PAI/aesthetic.md
