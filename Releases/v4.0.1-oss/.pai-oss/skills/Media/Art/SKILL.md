...
`~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load from:** `~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
...
bun run ~/.pai-oss/skills/Media/Art/Tools/Generate.ts \
