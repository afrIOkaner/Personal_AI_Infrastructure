 ...
 *
 * @see ~/.pai-oss/skills/art/README.md
 */
...
async function loadEnv(): Promise<void> {
  const paiDir = process.env.PAI_DIR || resolve(process.env.HOME!, '.pai-oss');
...
const PAI_DIR = process.env.PAI_DIR || `${process.env.HOME}/.pai-oss`;
