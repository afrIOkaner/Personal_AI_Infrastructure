...
# Load: ~/.pai-oss/skills/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '~/.pai-oss/skills/Remotion/theme'
...
- Load: `~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
- Apply: Charcoal aesthetic, purple accents, organic animations
- Reference: `~/.pai-oss/skills/Remotion/theme.ts`
