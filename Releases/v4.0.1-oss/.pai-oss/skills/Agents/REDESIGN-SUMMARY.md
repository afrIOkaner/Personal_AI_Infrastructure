...
Old YAML system backed up to: `~/.pai-oss/History/Backups/2025-12-18-AgentProfiles/`
...
bun run ~/.pai-oss/skills/Agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run ~/.pai-oss/skills/Agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run ~/.pai-oss/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
