...
bun run ~/.pai-oss/skills/Agents/Tools/ComposeAgent.ts \
...
- ComposeAgent tool: `~/.pai-oss/skills/Agents/Tools/ComposeAgent.ts`
- Voice mappings: `~/.pai-oss/skills/Agents/AgentPersonalities.md`
