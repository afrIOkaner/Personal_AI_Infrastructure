...
- **Built-in agents** (`~/.pai-oss/agents/*.md`): Use this format for the persona section
- **Custom agents** (`~/.pai-oss/custom-agents/*.md`): Use this format for the entire file
...
|--------|-------------------------|-------------------------------|
| Location | `~/.pai-oss/agents/` | `~/.pai-oss/custom-agents/` |
