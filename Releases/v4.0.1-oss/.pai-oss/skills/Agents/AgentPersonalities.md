...
**What happens:**
1. Run `bun run ~/.pai-oss/skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
- Trait definitions: `~/.pai-oss/skills/Agents/Data/Traits.yaml`
- Agent template: `~/.pai-oss/skills/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `~/.pai-oss/skills/Agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `~/.pai-oss/agents/*.md`
