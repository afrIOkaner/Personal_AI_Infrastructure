...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '~/.pai-oss/skills/hacking/bug-bounties',
    state: '~/.pai-oss/skills/hacking/bug-bounties/state.json',
    cache: '~/.pai-oss/skills/hacking/bug-bounties/cache',
    logs: '~/.pai-oss/skills/hacking/bug-bounties/logs',
  },
