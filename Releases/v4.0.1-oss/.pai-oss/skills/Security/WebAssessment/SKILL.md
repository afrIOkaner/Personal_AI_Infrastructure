...
`~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/WebAssessment/`
...
bun ~/.pai-oss/skills/Security/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun ~/.pai-oss/skills/Security/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun ~/.pai-oss/skills/Security/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun ~/.pai-oss/skills/Security/Recon/Tools/PortScan.ts target.com

# Path discovery
bun ~/.pai-oss/skills/Security/Recon/Tools/PathDiscovery.ts https://target.com
```
