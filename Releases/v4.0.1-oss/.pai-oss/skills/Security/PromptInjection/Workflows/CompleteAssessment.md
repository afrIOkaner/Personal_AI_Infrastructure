...
**Save to:**
```
~/.pai-oss/History/research/YYYY-MM-DD_[client]-recon/
...
```
~/.pai-oss/History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
**Document findings in:**
```
~/.pai-oss/History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
```
~/.pai-oss/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
~/.pai-oss/History/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
~/.pai-oss/History/research/YYYY-MM-DD_[client]-final-report/
