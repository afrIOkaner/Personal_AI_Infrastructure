...
`~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
bun run ~/.pai-oss/skills/Security/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run ~/.pai-oss/skills/Security/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run ~/.pai-oss/skills/Security/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
