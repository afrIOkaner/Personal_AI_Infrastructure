...
SCAN_FILE=~/.pai-oss/MEMORY/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_nmap-scan.txt

# Or masscan results
MASSCAN_FILE=~/.pai-oss/MEMORY/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_masscan.json

# Or combined multi-tool archive from history
SCAN_DIR=~/.pai-oss/History/security/scans/2025-11-target-recon/
```
...
// Usage: bun run tools/batch-scan-analysis.ts ~/.pai-oss/MEMORY/WORK/{current_work}/target-scans/
```
