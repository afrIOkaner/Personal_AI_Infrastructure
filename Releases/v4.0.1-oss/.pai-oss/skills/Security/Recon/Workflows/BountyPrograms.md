...
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts search "crypto"
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts search "finance"
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts update

# Export as JSON
bun ~/.pai-oss/skills/Security/Recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `~/.pai-oss/skills/Security/Recon/Data/BountyPrograms.json`
