...
- World models must exist at `~/.pai-oss/MEMORY/RESEARCH/WorldModels/`
...
```
Check ~/.pai-oss/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `~/.pai-oss/MEMORY/RESEARCH/WorldModels/`.
