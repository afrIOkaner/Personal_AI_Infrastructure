...
- Model template at `~/.pai-oss/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read ~/.pai-oss/MEMORY/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `~/.pai-oss/MEMORY/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `~/.pai-oss/MEMORY/RESEARCH/WorldModels/INDEX.md`:
