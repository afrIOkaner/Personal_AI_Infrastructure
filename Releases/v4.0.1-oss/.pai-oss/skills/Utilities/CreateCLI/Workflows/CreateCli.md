...
**Reference:** `~/.pai-oss/PAI/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see ~/.pai-oss/Bin/{{CLI_NAME}}/README.md
...
See: ~/.pai-oss/Bin/{{CLI_NAME}}/README.md
```
...
**Report to user:**
```
✅ CLI Created: ~/.pai-oss/Bin/{{CLI_NAME}}/
...
Documentation: ~/.pai-oss/Bin/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: ~/.pai-oss/Bin/notioncli/
...
3. Read: ~/.pai-oss/Bin/notioncli/README.md
...
Use proven structure from ~/.pai-oss/Bin/llcli/ as reference.
