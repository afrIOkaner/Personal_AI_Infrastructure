...
import { insertNewsletterContent } from '~/.pai-oss/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `~/.pai-oss/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `~/.pai-oss/skills/documents/pdf/forms.md`
- For parser integration, see `~/.pai-oss/skills/parser/SKILL.md`
- For newsletter database schema, see `~/.pai-oss/Context/databases/newsletter/schema.sql`
