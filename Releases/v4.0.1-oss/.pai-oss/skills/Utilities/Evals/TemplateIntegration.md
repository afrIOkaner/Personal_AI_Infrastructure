...
bun run ~/.pai-oss/Templates/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/judge-config.yaml \
  -o ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/judge-prompt.md
```
...
bun run ~/.pai-oss/Templates/Tools/RenderTemplate.ts \
  -t Evals/Rubric.hbs \
  -d ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/rubric.yaml \
  -o ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/rubric.md
```
