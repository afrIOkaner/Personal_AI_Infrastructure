...
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli.ts results \
  --use-case <name> \
  --latest
```
...
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli.ts report \
  --run-id <run-id> \
  --output ~/.pai-oss/skills/Utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
bun run ~/.pai-oss/Templates/Tools/RenderTemplate.ts \
  -t Evals/Report.hbs \
  -d ~/.pai-oss/skills/Utilities/Evals/Results/<use-case>/<run-id>/results.yaml \
  -o ~/.pai-oss/skills/Utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
```bash
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli.ts compare \
  --run-a <run-id-1> \
  --run-b <run-id-2>
```
...
```bash
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli.ts trend \
  --use-case <name> \
  --days 30
```
