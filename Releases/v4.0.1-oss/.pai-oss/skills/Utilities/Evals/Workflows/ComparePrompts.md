...
```bash
# Check prompts exist
ls ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/prompts/
...
Create `~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run ~/.pai-oss/Templates/Tools/RenderTemplate.ts \
  ...
  -d ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
