...
```bash
mkdir -p ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la ~/.pai-oss/skills/Utilities/Evals/UseCases/<name>/

# Validate config
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run ~/.pai-oss/skills/Utilities/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
