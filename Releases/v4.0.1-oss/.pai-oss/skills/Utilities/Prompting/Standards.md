...
**Location:** `~/.pai-oss/skills/Utilities/Fabric/Patterns/`
...
```bash
~/.pai-oss/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `~/.pai-oss/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ~/.pai-oss/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '~/.pai-oss/skills/Utilities/Prompting/Tools/RenderTemplate.ts';
