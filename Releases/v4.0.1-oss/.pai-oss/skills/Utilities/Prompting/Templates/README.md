...
```bash
bun run ~/.pai-oss/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
```bash
bun run ~/.pai-oss/skills/Utilities/Prompting/Tools/ValidateTemplate.ts \
...
- `~/.pai-oss/PAI/Prompting.md` (Templating section)
- `~/.pai-oss/History/research/2025-12/2025-12-09-templating-system-research.md`
- `~/.pai-oss/History/learnings/2025-12/2025-12-09-021700_LEARNING_complete-templating-system-and-evals-integration.md`
- `~/.pai-oss/skills/Utilities/Evals/SKILL.md`
