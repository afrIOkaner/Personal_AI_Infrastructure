...
```bash
~/.pai-oss/skills/[SkillName]/SKILL.md
```
...
```bash
touch ~/.pai-oss/skills/[SkillName]/Tools/ToolName.ts
touch ~/.pai-oss/skills/[SkillName]/Tools/ToolName.help.md
```
