...
1. Read the skill system documentation: `~/.pai-oss/PAI/SkillSystem.md`
2. Read the canonical example: `~/.pai-oss/skills/Research/SKILL.md`
...
```bash
mkdir -p ~/.pai-oss/skills/[SkillName]/Workflows
mkdir -p ~/.pai-oss/skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p ~/.pai-oss/skills/YourSkill/Workflows
mkdir -p ~/.pai-oss/skills/YourSkill/Tools
```
...
```bash
touch ~/.pai-oss/skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Reference:** `~/.pai-oss/PAI/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch ~/.pai-oss/skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch ~/.pai-oss/skills/YourSkill/Workflows/UpdatePublicRepo.md
touch ~/.pai-oss/skills/YourSkill/Workflows/Create.md
touch ~/.pai-oss/skills/YourSkill/Workflows/Publish.md
```
...
Run this check:
```bash
ls ~/.pai-oss/skills/[SkillName]/
ls ~/.pai-oss/skills/[SkillName]/Workflows/
ls ~/.pai-oss/skills/[SkillName]/Tools/
```
