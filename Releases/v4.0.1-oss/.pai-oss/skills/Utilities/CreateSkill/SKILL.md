...
`~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `~/.pai-oss/PAI/SkillSystem.md`

**Canonical example to follow:** `~/.pai-oss/skills/Research/SKILL.md`
...
**See:** `~/.pai-oss/PAI/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `~/.pai-oss/PAI/SkillSystem.md` (Dynamic Loading Pattern section)
