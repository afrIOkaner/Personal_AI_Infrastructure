...
| `~/.pai-oss/agents/BrowserAgent.md` | AI-driven browser agent definition |
| `~/.pai-oss/agents/UIReviewer.md` | User story validation agent definition |

## Related

- [BrowserAgent](~/.pai-oss/agents/BrowserAgent.md)
- [UIReviewer](~/.pai-oss/agents/UIReviewer.md)
