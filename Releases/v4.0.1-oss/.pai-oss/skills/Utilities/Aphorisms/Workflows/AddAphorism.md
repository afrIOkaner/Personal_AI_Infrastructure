...
**Prerequisites:**
- Aphorism database exists at `~/.pai-oss/skills/aphorisms/Database/aphorisms.md`
...
**Read database:**
```bash
Read ~/.pai-oss/skills/aphorisms/Database/aphorisms.md
```
...
Edit(
  file_path=~/.pai-oss/skills/aphorisms/Database/aphorisms.md,
