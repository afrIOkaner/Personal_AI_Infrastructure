...
PATTERN_PATH="$HOME/.pai-oss/skills/Fabric/Patterns/$PATTERN_NAME/system.md"
...
if [ -f "$PATTERN_PATH" ]; then
  ...
  ls ~/.pai-oss/skills/Fabric/Patterns/ | head -20
fi
```
...
**Pattern not found:**
```
Pattern '[name]' not found in ~/.pai-oss/skills/Fabric/Patterns/
