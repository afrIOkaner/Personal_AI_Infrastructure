...
- ~/.pai-oss/PAI/USER/TELOS/TELOS.md
- ~/.pai-oss/PAI/USER/TELOS/GOALS.md
- ~/.pai-oss/PAI/USER/TELOS/PROJECTS.md
- ~/.pai-oss/PAI/USER/TELOS/CHALLENGES.md
- ~/.pai-oss/PAI/USER/TELOS/STATUS.md
...
- Read ~/.pai-oss/MEMORY/STATE/current-work.json
...
- List skills in ~/.pai-oss/skills/
- List hooks in ~/.pai-oss/hooks/
- Read ~/.pai-oss/settings.json
...
1. Load channel config:
   bun ~/.pai-oss/PAI/Tools/LoadSkillConfig.ts ../youtube-channels.json
...
4. For NEW videos, extract transcripts:
   bun ~/.pai-oss/PAI/Tools/GetTranscript.ts '<video-url>'
...
1. Look in ~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/
...
1. Load the github_trending config from user-sources.json:
   Read ~/.pai-oss/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/user-sources.json
