...
Local pipeline definitions live in `~/.pai-oss/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md`
...
```bash
mkdir -p ~/.pai-oss/PAI/PIPELINES/[Domain]_[Pipeline-Name]
# PIPELINE-TEMPLATE.md is planned but not yet created
# For now, copy an existing pipeline and modify it
cp ~/.pai-oss/PAI/PIPELINES/Blog_Publish-Post/PIPELINE.md ~/.pai-oss/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md
```
...
- **Actions:** `~/.pai-oss/PAI/ACTIONS.md`
- **Flows:** `~/.pai-oss/PAI/FLOWS.md`
- **Architecture:** `~/.pai-oss/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `~/.pai-oss/PAI/PIPELINES/README.md`
