 ...
 *
 * EXAMPLES:
 *   algorithm -m loop -p ~/.pai-oss/MEMORY/WORK/auth/PRD-20260207-auth.md
...
const BASE_DIR = process.env.PAI_DIR || join(HOME, ".pai-oss");
...
PRD Resolution:
  Full path     ~/.pai-oss/MEMORY/WORK/auth/PRD-20260207-auth.md
