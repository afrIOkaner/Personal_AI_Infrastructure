 ...
 *
 * Harvests insights from ~/.pai-oss/projects/ sessions and writes to LEARNING/
 *
 * Commands:
...
const PAI_DIR = path.join(process.env.HOME!, ".pai-oss");
// Derive the project slug dynamically from PAI_DIR (works on macOS and Linux)
// macOS: ${HOME}/.pai-oss → -Users-username--claude
// Linux: /home/username/.pai-oss → -home-username--claude
const CWD_SLUG = PAI_DIR.replace(/[\/\.]/g, "-");
const PROJECTS_DIR = path.join(PAI_DIR, "projects", CWD_SLUG);
