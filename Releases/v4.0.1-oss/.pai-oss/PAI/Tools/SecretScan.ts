 ...
 *
 * Usage:
 *   bun ~/.pai-oss/PAI/Tools/SecretScan.ts <directory>
 *   bun ~/.pai-oss/PAI/Tools/SecretScan.ts . --verbose
 *   bun ~/.pai-oss/PAI/Tools/SecretScan.ts . --verify
 *
 * @see ~/.pai-oss/skills/_SYSTEM/Workflows/SecretScanning.md
 */
