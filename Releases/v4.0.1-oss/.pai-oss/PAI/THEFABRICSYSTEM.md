...
**Primary Skill:** `~/.pai-oss/skills/Fabric/SKILL.md`
...
**Patterns Location:** `~/.pai-oss/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to ~/.pai-oss/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ ~/.pai-oss/skills/Fabric/Patterns/
```
...
- **Full Skill:** `~/.pai-oss/skills/Fabric/SKILL.md`
- **Pattern Execution:** `~/.pai-oss/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `~/.pai-oss/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `~/.pai-oss/skills/Fabric/Patterns/`
