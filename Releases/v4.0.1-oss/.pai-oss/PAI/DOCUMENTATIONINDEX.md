...
**All documentation files are in `~/.pai-oss/PAI/` with USER/ subdirectory for personal overrides. Read these files when you need deeper context.**
...
**Agent System:**
- **Agents Skill** (`~/.pai-oss/skills/Agents/`) - Complete agent composition system | See Agents skill for custom agent creation, traits, and voice mappings
