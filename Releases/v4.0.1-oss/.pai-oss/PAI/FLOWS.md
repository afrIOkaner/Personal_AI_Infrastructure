...
Local flow definitions are tracked in `~/.pai-oss/PAI/FLOWS/flow-index.json`:
...
Flow state (run history, errors) is tracked in `~/.pai-oss/MEMORY/STATE/flow-state.json`.
...
- **Actions:** `~/.pai-oss/PAI/ACTIONS.md` *(planned)*
- **Pipelines:** `~/.pai-oss/PAI/PIPELINES.md`
- **Architecture:** `~/.pai-oss/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `~/.pai-oss/PAI/FLOWS/README.md`
